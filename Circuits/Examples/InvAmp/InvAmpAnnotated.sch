...
C {devices/rectangle.sym} 300 -500 0 0 {name=group lab=Group}
C {devices/resistor.sym} 440 -460 0 0 {name=R1 lab=R1 color=red}
C {devices/capacitor.sym} 600 -460 0 0 {name=C1 lab=C1 color=blue}
C {devices/nmos.sym} 760 -460 0 0 {name=NMOS1 lab=NMOS1 color=green}
C {devices/label.sym} 420 -550 0 0 {name=label lab=Inverting Amplifier}
